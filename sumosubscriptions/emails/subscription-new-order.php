...
<?php if ( $admin_template ) { ?>
    <p><?php printf( __( 'You have received a Autoship Subscription order from %s %s. The Autoship Subscription order is as follows:' , 'sumosubscriptions' ) , sumosubs_get_order_billing_first_name( $order ) , sumosubs_get_order_billing_last_name( $order ) ) ; ?></p>
<?php } else { ?>
    <p><?php printf( __( 'You have placed a new Autoship Subscription order on %s. The Autoship Subscription order is as follows:' , 'sumosubscriptions' ) , get_option( 'blogname' ) ) ; ?></p>
<?php } ?>
