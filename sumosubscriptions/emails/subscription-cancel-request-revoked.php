...
<p><?php printf( __( 'Your request to revoke the Autoship Subscription cancellation of #%s has been proccessed successfully.' , 'sumosubscriptions' ) , sumo_get_subscription_number( $post_id ) ) ; ?></p>
