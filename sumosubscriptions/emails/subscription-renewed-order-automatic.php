...
<p><?php printf( __( 'Renewal of your Autoship Subscription #%s on %s has been successfully completed.' , 'sumosubscriptions' ) , sumo_get_subscription_number( $post_id ) , get_option( 'blogname' ) ) ; ?></p>
