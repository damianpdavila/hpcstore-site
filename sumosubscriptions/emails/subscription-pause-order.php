...
<p>
    <?php
    printf( __( 'Your Autoship Subscription #%s is currently Paused' , 'sumosubscriptions' ) , sumo_get_subscription_number( $post_id ) ) ;

    if ( ! empty( $_POST[ 'auto_resume_on' ] ) ) {
        printf( __( ' your Autoship Subscription will be automatically resume on <b>%s</b>.' , 'sumosubscriptions' ) , $_POST[ 'auto_resume_on' ] ) ;
    }
    ?>
</p>
