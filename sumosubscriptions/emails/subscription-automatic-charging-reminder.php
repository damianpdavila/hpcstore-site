...
<?php if ( $order->has_status( 'pending' ) ) : ?>
    ...
    <p><?php printf( __( 'Hi, <br>This is to remind you that your Autoship Subscription #%s will be automatically renewed on <b>%s</b> because you have already preapproved for automatic charging. <br>Kindly make sure you have sufficient funds in your account. ' , 'sumosubscriptions' ) , sumo_get_subscription_number( $post_id ) , $payment_charging_date ) ; ?></p>
