...
<?php if ( $order->has_status( 'pending' ) ) : ?>
    <p>
        ...
        printf( __( 'Your Autoship Subscription #%s is in Overdue status because we couldn\'t charge your account for Autoship Subscription Renewal. Please make sure that you have sufficient funds in your account. <br>%s. If payment is not made for the Autoship Subscription Renewal by <b>%s</b>. Your Autoship Subscription will move to <b>%s</b> status.' , 'sumosubscriptions' ) , sumo_get_subscription_number( $post_id ) , $link , $upcoming_mail_date , $upcoming_mail_status ) ;
        ?>
    </p>
<?php endif ; ?>
